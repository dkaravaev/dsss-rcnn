...
from fb.bn import ComplexPBN as complex_normalization

from complexnn.bn import sqrt_init
from complexnn.init import ComplexInit, ComplexIndependentFilters
...
class ComplexConv(Layer):
    ...
    def call(self, inputs):
        ...
        if self.normalize_weight:
            ...
            Vrr = K.mean(reshaped_f_real ** 2, axis=reduction_axes) + self.epsilon
            Vii = K.mean(reshaped_f_imag ** 2, axis=reduction_axes) + self.epsilon
            Vri = K.mean(reshaped_f_real * reshaped_f_imag,
